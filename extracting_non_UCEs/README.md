...
gatk HaplotypeCaller -R sle117_final_mitobim.fasta -I temp_realigned_reads.bam -stand_call_conf 30 -o temp_raw_variants.vcf --maxNumHaplotypesInPopulation 1
